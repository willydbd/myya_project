...
var imagePuzzle = {
    ...
    setImage: function (images, gridSize) {
        ...
        var real_image = image.src.split("/")[3];
        console.log(real_image);
        $('#imgTitle').html(image.title);
        $('#actualImage').css({'background-image': "url(assets/img/images/" + real_image +")","background-size" : "cover","background-repeat":"no-repeat","background-position":"center","height":"220px", "width":"100%"});
        $('#sortable').empty();
